...
<tr><td>2</td><td>`qvp_company_employee_id`</td><td>integer</td><td></td><td>[`qvp_company_employees`](qvp_company_employees.md)</td><td></td></tr>
<tr><td>3</td><td>`report_file_id`</td><td>uuid</td><td></td><td>[`file_storage`](file_storage.md)</td><td>TODO: it isn't referencing file_storage in stg v2 db! An error?</td></tr>
