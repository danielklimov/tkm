...
<tr><td>2</td><td>`user_id`</td><td>uuid</td><td></td><td>[`users`](users.md)</td><td>User account used by the employee to log in to app</td></tr>
<tr><td>3</td><td>`qvp_company_id`</td><td>uuid</td><td></td><td>[`qvp_companies`](qvp_companies.md)</td><td>QVP company the user works for</td></tr>
